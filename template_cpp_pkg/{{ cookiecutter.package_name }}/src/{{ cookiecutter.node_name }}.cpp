...
#include <{{ cookiecutter.package_name }}/{{ cookiecutter.node_name }}.hpp>
...
// parameter names
const std::string {{ cookiecutter.node_cpp_class_name }}::kPeriodParam = "period";

// constants
const std::string {{ cookiecutter.node_cpp_class_name }}::kInputTopic = "~/topic";
const std::string {{ cookiecutter.node_cpp_class_name }}::kOutputTopic = "~/topic";
 ...
 *
 */
{{ cookiecutter.node_cpp_class_name }}::{{ cookiecutter.node_cpp_class_name }}() : Node("template_node") {
 ...
 *
 */
void {{ cookiecutter.node_cpp_class_name }}::loadParameters() {
 ...
 *
 */
void {{ cookiecutter.node_cpp_class_name }}::setup() {

  // create a callback for dynamic parameter configuration
  parameters_callback_ = this->add_on_set_parameters_callback(
    std::bind(&{{ cookiecutter.node_cpp_class_name }}::parametersCallback, this, std::placeholders::_1));
  ...
  subscriber_ =
    this->create_subscription<template_interfaces_pkg::msg::TemplateMessage>(
      kInputTopic, 10,
      std::bind(&{{ cookiecutter.node_cpp_class_name }}::topicCallback, this, std::placeholders::_1));
  ...
  publish_timer_ =
    this->create_wall_timer(std::chrono::duration<double>(period_),
                            std::bind(&{{ cookiecutter.node_cpp_class_name }}::publishTimerCallback,
                            this));

  // create a service server for handling service calls
  service_server_ =
    this->create_service<template_interfaces_pkg::srv::TemplateService>(
      "service", std::bind(&{{ cookiecutter.node_cpp_class_name }}::serviceCallback, this,
  ...
  action_server_ = rclcpp_action::create_server<
    ...
    this, "action",
    std::bind(&{{ cookiecutter.node_cpp_class_name }}::actionHandleGoal, this, std::placeholders::_1,
              std::placeholders::_2),
    std::bind(&{{ cookiecutter.node_cpp_class_name }}::actionHandleCancel, this, std::placeholders::_1),
    std::bind(&{{ cookiecutter.node_cpp_class_name }}::actionHandleAccepted, this,
              std::placeholders::_1));
}
 ...
 */
rcl_interfaces::msg::SetParametersResult {{ cookiecutter.node_cpp_class_name }}::parametersCallback(
 ...
 * @param[in] msg   input
 */
void {{ cookiecutter.node_cpp_class_name }}::topicCallback(
 ...
 *
 */
void {{ cookiecutter.node_cpp_class_name }}::publishTimerCallback() {
 ...
 */
void {{ cookiecutter.node_cpp_class_name }}::serviceCallback(
 ...
 */
rclcpp_action::GoalResponse {{ cookiecutter.node_cpp_class_name }}::actionHandleGoal(
 ...
 */
rclcpp_action::CancelResponse {{ cookiecutter.node_cpp_class_name }}::actionHandleCancel(
 ...
 * @param[in] goal_handle     input
 */
void {{ cookiecutter.node_cpp_class_name }}::actionHandleAccepted(
  const std::shared_ptr<rclcpp_action::ServerGoalHandle<
    template_interfaces_pkg::action::TemplateAction>>
    goal_handle) {
  ...
  std::thread{
    std::bind(&{{ cookiecutter.node_cpp_class_name }}::actionExecute, this, std::placeholders::_1),
    goal_handle}
    .detach();
}
 ...
 * @param[in] goal_handle     input
 */
void {{ cookiecutter.node_cpp_class_name }}::actionExecute(
  const std::shared_ptr<rclcpp_action::ServerGoalHandle<
    template_interfaces_pkg::action::TemplateAction>>
    goal_handle) {
...
int main(int argc, char *argv[]) {
  ...
  rclcpp::spin(std::make_shared<{{ cookiecutter.package_name }}::{{ cookiecutter.node_cpp_class_name }}>());
  rclcpp::shutdown();
